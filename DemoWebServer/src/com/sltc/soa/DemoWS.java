...
public class DemoWS
{
    ...
    public float currencyConverter(float amount, String currencyFrom, String currencyTo)
    {
        if(0==exchangeRate(currencyFrom) || 0==exchangeRate(currencyTo))
        {
        ...
        {
            float result=(amount/exchangeRate(currencyFrom))*(exchangeRate(currencyTo));
            System.out.println(amount+" "+currencyFrom+" = "+(amount/exchangeRate(currencyFrom))+
                    " USD = " + result +" "+currencyTo);
    ...
    public float exchangeRate(String currency)
    {
